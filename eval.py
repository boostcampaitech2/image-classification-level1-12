...
def main(config):
    ...
    checkpoint_file_path = "/tmp/pycharm_project_862/saved/models/Mnist_LeNet/0825_213707/model_best.pth"
    ...
    submission.to_csv('./saved/submission/submission.csv', index=False)
