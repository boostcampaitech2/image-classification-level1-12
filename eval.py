...
def main(config):
    ...
    checkpoint_file_path = "/tmp/PycharmProjects/image-classification-level1-12_hwang/saved/models/Mask_vgg19_lin2/0831_103443/checkpoint-epoch13.pth"
    ...
    submission.to_csv('./saved/submission/submission_0831_103443_13.csv', index=False)
    # epoch: 3
