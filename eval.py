...
def main(config):
    ...
    checkpoint_file_path = "/tmp/PycharmProjects/image-classification-level1-12_hwang/saved/models/Mask_vgg19_lin2/0831_085522/model_best.pth"
    ...
    submission.to_csv('./saved/submission/submission_0831_085522_12.csv', index=False)
    # epoch: 3
