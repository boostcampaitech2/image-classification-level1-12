...
def main(config):
    ...
    checkpoint_file_path = "/tmp/PycharmProjects/image-classification-level1-12_hwang/saved/models/Mask_vgg19_lin2/0901_093736/model_best.pth"
    ...
    submission.to_csv('./saved/submission/submission_0901_093736_20.csv', index=False)
    # epoch: 3
