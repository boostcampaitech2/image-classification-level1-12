...
from data_process.class_converter import age_to_age_class, mask_to_mask_class, sm_mask_to_mask_class
    ...
    def __init__(
        ...
        if self._num_folds < 2:
            for _, meta_row in meta_data_all.iterrows():
                for mask_file_name in self.TRAIN_MASK_FILE_NAMES:
...
class MaskHFTrainDataset(MaskTrainDataset):
    # Add upsampling file name - mickeyshoes
    TRAIN_MASK_FILE_NAMES = ("normal", "mask1", "mask2", "mask3", "mask4", "mask5", "incorrect_mask",
                             "normal_hf", "mask1_hf", "mask2_hf", "mask3_hf", "mask4_hf", "mask5_hf",
                             "incorrect_mask_hf")
